package se.juneday.systemapp;

import android.content.DialogInterface;
import android.support.v7.app.AlertDialog;
import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
// below are the suggestions for possible import classes that are missing
...
import se.juneday.systemapp.domain.Product;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void searchProducts(Map<String, String> arguments) {
       ...
       //String url = "http://192.168.0.5:8080/search/products/all?" + argumentString;
       // String url = "http://localhost:8080/search/products/all?" + argumentString;
        String url = "http://10.0.2.2:8080/search/products/all/" + argumentString;
